...
namespace QuanLyQuanNet.Admin.NhanVien
{
    public partial class admin_NhanVien : UserControl
    {
        ...
        private void button_Them_Click(object sender, EventArgs e)
        {
            ...
            string query = @"INSERT INTO NhanVien (ID, HoTen, ChucVu, LoaiNhanVien, DiaChi, SDT, NgaySinh, NgayVaoLam, TaiKhoan, MatKhau)
                             VALUES (@ID, @HoTen, @ChucVu, @LoaiNhanVien, @DiaChi, @SDT, @NgaySinh, @NgayVaoLam, @TaiKhoan, @MatKhau)";
